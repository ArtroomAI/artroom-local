...
import {
  ...
  function PaintImg2Img() {
    ...
    const [running, setRunning] = useRecoilState(atom.runningState);
    ...
    const submitPaintImg2Img = event => {
        if (!running || keep_warm){
            setRunning(true);
            var output = {
          ...
          <>
            ...
            <Box bg="gray.1000" p={4} width='100%' height="100%" rounded="md">
              ...
              <HStack spacing="30px" ml="-40px">
                ...
                <HStack>                  
                  <Button onClick = {submitPaintImg2Img} colorScheme="purple" ml={2} width="250px"
                    // isLoading = {running}
