...
try:
    ...
    parser.add_argument("--steps", type=int, help="Select interpolation steps at which the Models will be merged. 5 will result in 5% 10% 15% 20%", default=0, required=False)
