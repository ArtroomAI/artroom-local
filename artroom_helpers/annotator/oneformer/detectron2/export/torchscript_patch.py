...
from artroom_helpers.annotator.oneformer.detectron2.utils.env import _import_file
...
def patch_nonscriptable_classes():
    ...
    from artroom_helpers.annotator.oneformer.detectron2.modeling.backbone import ResNet, FPN
    ...
    from artroom_helpers.annotator.oneformer.detectron2.modeling.roi_heads import StandardROIHeads
