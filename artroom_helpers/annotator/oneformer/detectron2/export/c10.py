...
from artroom_helpers.annotator.oneformer.detectron2.layers import ShapeSpec, cat
from artroom_helpers.annotator.oneformer.detectron2.layers.roi_align_rotated import ROIAlignRotated
