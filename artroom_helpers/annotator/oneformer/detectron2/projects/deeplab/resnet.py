...
from artroom_helpers.annotator.oneformer.detectron2.layers import CNNBlockBase, Conv2d, get_norm
from artroom_helpers.annotator.oneformer.detectron2.modeling import BACKBONE_REGISTRY
from artroom_helpers.annotator.oneformer.detectron2.modeling.backbone.resnet import (
    BasicStem,
    BottleneckBlock,
