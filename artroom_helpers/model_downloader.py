...
os.makedirs(
    f"{userprofile}/artroom/upscalers/Real-ESRGAN/weights/", exist_ok=True)
os.makedirs(
    f"{userprofile}/artroom/upscalers/Real-ESRGAN/experiments/", exist_ok=True)
os.makedirs(
    f"{userprofile}/artroom/upscalers/Real-ESRGAN/experiments/pretrained_models/", exist_ok=True)
os.makedirs(f"{userprofile}/artroom/upscalers/GFPGAN/", exist_ok=True)
os.makedirs(
    f"{userprofile}/artroom/upscalers/GFPGAN/experiments/", exist_ok=True)
os.makedirs(
    f"{userprofile}/artroom/upscalers/GFPGAN/experiments/pretrained_models/", exist_ok=True)
os.makedirs(f"{userprofile}/artroom/upscalers/GFPGAN/gfpgan/", exist_ok=True)
os.makedirs(
    f"{userprofile}/artroom/upscalers/GFPGAN/gfpgan/weights/", exist_ok=True)
...
if not os.path.exists(f"{userprofile}/artroom/settings/sd_settings.json"):
    ...
    original_json = json.load(
        open(f"{userprofile}/artroom/settings/sd_settings.json"))
...
if os.path.exists(f"{userprofile}/artroom/settings/queue.json"):
    os.remove(f"{userprofile}/artroom/settings/queue.json")
