...
const api = {
  startArtroom: (artroomPath: string, isDebug: boolean) =>
    IPC.invoke('startArtroom', artroomPath, isDebug),
  runPyTests: (artroomPath: string) => IPC.invoke('runPyTests', artroomPath),
  imageViewer: (folder_path: string, batch_path: string): Promise<ImageViewerResultType> =>
    IPC.invoke('imageViewer', folder_path, batch_path),
  ...
  getImageFromPath: (image_path: string): Promise<BackEndImage> =>
    IPC.invoke('getImageFromPath', image_path),
  ...
  restartServer: (artroomPath: string, isDebug: boolean) =>
    IPC.invoke('restartServer', artroomPath, isDebug),
  ...
  pythonInstall: (artroomPath: string, gpuType: string) =>
