        ...
        >
          <VStack display="flex" justifyContent="center" alignItems="center" maxW={'500px'}>
            <Text
              ...
              textAlign="center"
              justifyContent="center"
            >{`Discover our latest feature in early access! Join us on Patreon as an early subscriber to try it out :)`}</Text>
            <Box p={4} mx="auto">
              <FormControl>
                <FormLabel>Early Access Code:</FormLabel>
                <Flex align="center">
                  <Input type="string" value={password} onChange={handlePasswordChange} mr={2} />
