...
import { Flex, Heading, Button, Stack, Box, Link, Image, Text, useToast } from '@chakra-ui/react'
...
const ForgotPasswordCode = ({
  ...
  setPwdResetJwt: React.Dispatch<React.SetStateAction<string>>
  ...
  function handlePasswordVerify() {
    ...
    console.log(body)
    axios
      .post(`${ARTROOM_URL}/forgot_password_enter_code`, body, {
        headers: {
          'Content-Type': 'application/json',
          accept: 'application/json',
        },
        ...
        <Box minW={{ base: '90%', md: '468px' }}>
          <Stack backgroundColor="whiteAlpha.900" boxShadow="md" p="1rem" spacing={4}>
            <Text width="500px" color="gray.800">
              A verification code has been sent to your email. Please enter the code below. It will
              expire in 10 minutes. Please also check your spam.
            </Text>
            <PinInputCode
