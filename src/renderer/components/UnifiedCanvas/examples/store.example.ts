...
// import optionsReducer from 'options/store/optionsSlice';
// import galleryReducer from 'gallery/store/gallerySlice';
// import systemReducer from 'system/store/systemSlice';
// import canvasReducer from 'canvas/store/canvasSlice';
