...
export const CanvasStatusText: FC = () => {
  ...
  const boundingBoxCoordinatesString = useRecoilValue(boundingBoxCoordinatesStringSelector)
  const boundingBoxDimensionsString = useRecoilValue(boundingBoxDimensionsStringSelector)
  const scaledBoundingBoxDimensionsString = useRecoilValue(
    scaledBoundingBoxDimensionsStringSelector
  )
  const shouldShowScaledBoundingBox = useRecoilValue(shouldShowScaledBoundingBoxSelector)
  const canvasCoordinatesString = useRecoilValue(canvasCoordinatesStringSelector)
  const canvasDimensionsString = useRecoilValue(canvasDimensionsStringSelector)
  const shouldShowCanvasDebugInfo = useRecoilValue(shouldShowCanvasDebugInfoAtom)
