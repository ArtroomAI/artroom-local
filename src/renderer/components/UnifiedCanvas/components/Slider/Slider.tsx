...
export function Slider(props: IFullSliderProps) {
  ...
  return (
    <FormControl
      className={
        styleClass ? `painter__slider-component ${styleClass}` : `painter__slider-component`
      }
      data-markers={withSliderMarks}
      {...sliderFormControlProps}
    >
      <FormLabel className="painter__slider-component-label" {...sliderFormLabelProps}>
        {label}
      </FormLabel>
      ...
      <HStack w="100%" gap={2}>
        ...
        >
          ...
          <Tooltip
            ...
            {...sliderTooltipProps}
          >
            <SliderThumb className="painter__slider-thumb" {...sliderThumbProps} />
          </Tooltip>
        </ChakraSlider>
