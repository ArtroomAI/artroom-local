...
import { InProgressImageType, LogEntry } from './examples/system.store.example/systemSlice.example'
...
export declare type PostProcessedImageMetadata = ESRGANMetadata | FacetoolMetadata
