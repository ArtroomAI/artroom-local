...
import { colorPickerColorAtom, commitColorPickerColorAction } from '../atoms/canvas.atoms'
...
export const useColorPicker = () => {
  ...
  const commitColorPickerColor = useSetRecoilState(commitColorPickerColorAction)
