        ...
        <Box
            ...
            <form>
                <VStack
                    ...
                    <FormControl
                        ...
                        <HStack>
                            <Input
                                id="images"
                                name="images"
                                onChange={(event) => setImages(event.target.value.split(',')?.filter(e => e !== ''))}
                                type="text"
                                value={images}
                                variant="outline"
                            />
                    ...
                    <FormControl
                        className="trigger_word"
                        width="full">
                        <FormLabel htmlFor="trigger_word">
                        ...
                        <AccordionItem>
                            ...
                            <Grid templateColumns="repeat(2, 1fr)" gap={6}>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={512} max={1024} step={64} value={resolutionWidth} onChange={value => setResolutionWidth(parseInt(value))}>
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={512} max={1024} step={64} value={resolutionHeight} onChange={value => setResolutionHeight(parseInt(value))}>
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={0} max={1} value={unetLr} onChange={value => setUnetLr(parseFloat(value))}  >
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={0} max={1024} step={4} value={networkDim} onChange={value => setNetworkDim(parseInt(value))}  >
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={0} step={1} value={lrSchedulerNumCycles} onChange={value => setLrSchedulerNumCycles(parseInt(value))}  >
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={64} step={64}  value={bucketResoSteps} onChange={value => setBucketResoSteps(parseInt(value))}  >
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={64} step={64}  value={minBucketReso} onChange={value => setMinBucketReso(parseInt(value))}  >
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
                                ...
                                <FormControl>
                                    ...
                                    <NumberInput min={64} step={64}  value={maxBucketReso} onChange={value => setMaxBucketReso(parseInt(value))}  >
                                    <NumberInputField />
                                    </NumberInput>
                                </FormControl>
                                </GridItem>
