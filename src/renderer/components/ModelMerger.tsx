...
export const ModelMerger = () => {
  ...
  return (
    <Box height="90%" ml="30px" p={4} rounded="md" width="75%">
      <form>
        <VStack align="flex-start" spacing={5}>
          <FormControl width="full">
            <HStack>
              ...
              <FormLabel htmlFor="upscale_images">Select interpolation method</FormLabel>
            </HStack>

            <HStack>
              <RadioGroup onChange={setInterpolation} value={interpolation}>
                <Stack direction="row">
                  <Radio value="weighted_sum">Weighted Sum</Radio>

                  <Radio value="add_difference">Add Difference</Radio>
                </Stack>
              </RadioGroup>
            </HStack>
          </FormControl>
          ...
          <FormControl width="full">
            ...
            <Select
              ...
              variant="outline"
            >
              {models.ckpts.length > 0 ? <option value="">Select model weights</option> : <></>}
          ...
          {!fullrange ? (
            <FormControl pt={5} width="full">
              <Flex>
                <FormHelperText textAlign="left">
                  <Text>{`${modelA.slice(0, 30)} ${alpha}%`}</Text>
                </FormHelperText>
                <Spacer></Spacer>
                <FormHelperText textAlign="right">
                  <Text>{`${modelB.slice(0, 30)} ${modelC.slice(0, 30)} ${100 - alpha}%`}</Text>
                </FormHelperText>
              </Flex>
              <Slider
            ...
            <HStack>
              <FormControl>
                <FormLabel htmlFor="start_steps">Starting %</FormLabel>
              ...
              <FormControl>
                <FormLabel htmlFor="end_steps">Ending %</FormLabel>
              ...
              <FormControl>
                <FormLabel htmlFor="steps">% Increment</FormLabel>
                <NumberInput
                  id="steps"
                  min={0}
                  max={100}
          ...
          <FormControl alignContent="center" width="full">
            <VStack spacing={3}>
              <Button className="run-button" ml={2} onClick={submitMain} width="200px">
                Merge
              </Button>
            </VStack>
          </FormControl>
