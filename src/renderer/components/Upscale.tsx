...
function Upscale() {
  ...
  const upscale = useCallback(() => {
    ...
    toast({
      title: 'Received!',
      description:
        "You'll get a notification 🔔 when your upscale is ready! (First time upscales make take longer while it downloads the models)",
      status: 'success',
      position: 'top',
      duration: 3000,
      isClosable: false,
  ...
  return (
    <Box height="90%" ml="30px" p={4} rounded="md" width="100%">
      <form>
          ...
          <FormControl className="upscale-images-input" width="full">
            ...
            <HStack>
              <Input
                ...
                name="upscale_images"
                onChange={(event) =>
                  setUpscaleImages(event.target.value.split(',')?.filter((e) => e !== ''))
                }
                type="text"
          ...
          <HStack>
            <FormControl className="upscaler-input">
              <Select
                ...
                w="300px"
              >
                <option value="">Choose Upscaler</option>

                <option value="UltraSharp">4x UltraSharp</option>

                <option value="GFPGANv1.3">GFPGANv1.3</option>

                <option value="GFPGANv1.4">GFPGANv1.4</option>
                ...
                <option value="RealESRGAN-Anime">RealESRGAN-Anime</option>
              </Select>
            </FormControl>
