...
import { MenuButton, HStack, Icon, Text, Flex, Menu, Link, Tooltip } from '@chakra-ui/react'
import {
  TOUR_STEPS_MAIN,
  TOUR_STEPS_PAINT,
  TOUR_STEPS_QUEUE,
    ...
    <>
      ...
      >
        <Menu placement="right">
          <Link _hover={{ textDecor: 'none', backgroundColor: '#AEC8CA' }} borderRadius={8} p={2.5}>
            <Tooltip
              fontSize="md"
              label={navSize === 'small' ? 'Tutorial' : ''}
              placement="bottom"
              shouldWrapChildren
            >
              <MenuButton bg="transparent" className="tour-link" width="100%">
                <HStack>
                  <Icon
                    as={FaQuestionCircle}
                    color="#82AAAD"
