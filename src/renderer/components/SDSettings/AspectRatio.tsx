...
const ASPECT_RATIOS = ['1:1', '1:2', '2:1', '4:3', '3:4', '16:9', '9:16', 'Custom']
        ...
        <VStack width="100%">
          <FormControl className="width-input">
            ...
            >
              ...
              <Tooltip bg="#4f8ff8" color="white" isOpen={true} label={`${width}`} placement="left">
                <SliderThumb />
              </Tooltip>
            </Slider>
          </FormControl>
        ...
        <FormControl width="50%" className="aspect-ratio-input" marginBottom={2}>
          <VStack>
            ...
            >
              ...
              {initImage.length && <option value="Init Image">Init Image</option>}
