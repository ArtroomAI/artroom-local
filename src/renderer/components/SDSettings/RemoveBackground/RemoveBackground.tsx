  ...
  return (
    <VStack>
      <FormControl className="remove-background-input">
        <HStack>
          <FormLabel htmlFor="Remove Background">Background Removal Mode</FormLabel>
        </HStack>
        <HStack>
          <Select
          ...
          >
            ...
            <option value="u2net">Standard</option>
          ...
          <Button
            ...
            onClick={() => {
              socket.emit('preview_remove_background', {
                initImage,
      ...
      <HStack>
        <FormLabel htmlFor="use_random_seed">Remove Background in Gen</FormLabel>
        <Checkbox
      ...
      {removeBackgroundPreview.length > 0 && <RemoveBackgroundPreview></RemoveBackgroundPreview>}
    </VStack>
  )
}
