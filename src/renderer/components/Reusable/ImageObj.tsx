...
export default function ImageObj({
  b64 = '',
  path = '',
  active,
}: Partial<ImageState> & { active: boolean }) {
    ...
    <ContextMenu>
      <ContextMenuTrigger>
        {active ? (
          ...
          <Image fit="scale-down" h="55vh" src={b64} onClick={handleOpen} />
        )}
        <Modal size="6xl" isOpen={showModal} onClose={handleClose} scrollBehavior="outside">
          <ModalOverlay bg="blackAlpha.900" />
          <ModalContent>
            <ModalBody display="flex" justifyContent="center">
              <Image alignSelf="center" fit="scale-down" h="100%" src={b64} />
            </ModalBody>
          </ModalContent>
        </Modal>
      </ContextMenuTrigger>
      ...
      <ContextMenuList>
        ...
        <ContextMenuItem onClick={copyToClipboard}>Copy To Clipboard</ContextMenuItem>

        <ContextMenuItem onClick={showItemInFolder}>Show In Explorer</ContextMenuItem>
      </ContextMenuList>
    </ContextMenu>
  )
}
