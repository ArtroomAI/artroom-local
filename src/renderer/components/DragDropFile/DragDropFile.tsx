...
import { FaTrashAlt, FaClipboardList, FaQuestionCircle } from 'react-icons/fa'
...
const DragDropFile = () => {
  ...
  return (
    <VStack>
      ...
      <Box bg="#080B16" height="180px" width="180px" {...getRootProps()}>
        <Box
          border="1px"
          borderStyle="ridge"
          height="180px"
        ...
        >
          {initImage.length > 0 ? (
            <ChakraImage boxSize="178px" fit="contain" rounded="md" src={initImage} />
          ) : (
            <>
          ...
          <IconButton
            ...
            onClick={() => {
              navigator.clipboard.read().then((data) => {
                ...
                if (
                  clip &&
                  (clip.types.includes('image/png') || clip.types.includes('image/jpeg'))
                ) {
