...
export interface SocketEmitEvents {
  ...
  preview_remove_background: (data: { initImage: string; remove_background: string }) => void
  preview_controlnet: (data: { initImage: string; controlnet: string; models_dir: string }) => void
}
