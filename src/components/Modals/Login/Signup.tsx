...
const SignUp = ({
  ...
  const checkValidDOB = () => {
    const isDOBValid =
      day.value.length > 0 && month.value.length > 0 && year.value.length > 0
  ...
  for (let i = 1; i < 32; i++) {
    ...
    days.push({ value: iString, label: iString })
  }

  const years: DateType[] = []
            ...
            <FormControl>
              ...
              <InputGroup>
                ...
                <Input
                  _placeholder={{ color: 'gray.400' }}
                  borderColor={
                    emailValid && emailUnique ? '#00000020' : '#FF0000'
                  }
                  color="gray.800"
                  onChange={event => {
                    setEmailValid(true)
            ...
            <FormControl>
              {!passwordValid && (
                <FormHelperText textAlign="left">
                  ...
                  <Text color="red.300">
                    Must at least 8 characters and include a number, and a
                    symbol
                  </Text>
                </FormHelperText>
              )}
