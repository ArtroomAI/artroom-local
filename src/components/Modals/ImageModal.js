        ...
        <ModalBody>
            <Flex>
                <Box>
                    ...
                    <Button borderRadius="10" variant="ghost" variantColor="blue" mr={2} fontSize="14"  fontWeight="normal">
                ...
                <Box pt="5" width="100%" display="flex" justifyContent="center">
                    <Button borderRadius="10" variant="ghost" variantColor="blue" fontSize="14" fontWeight="normal" isDisabled={!('text_prompts' in imageModalMetadata)}>
