...
function PromptGuide() {
    return (
        <VStack p = {5}>
            <Flex w = '100%' ml='10px' bg='gray.1000'>
                <Container maxW={'3xl'}>
                    <Stack
                    as={Box}
                    textAlign={'center'}
                    ...
                    <Heading
                        ...
                        <Text as={'span'} fontWeight={300}fontSize={{ base: '2xl', sm: '4xl', md: '6xl' }}>
                        A guide by    <br/>
                        </Text>
                        <Text href='https://twitter.com/dailystablediff' color={'green.400'}>
                            Graverman
                        </Text>
                        <Text color={'green.400'} fontSize={'medium'}>https://twitter.com/dailystablediff</Text>
                    </Heading>
                    <Text color={'gray.500'}>
                    ...
                    <Text color={'gray.500'} fontWeight={300}fontSize={{ base: '2xl', sm: '4xl', md: '6xl' }}>
                    1. Raw prompt
                    </Text>
                    <Text>
