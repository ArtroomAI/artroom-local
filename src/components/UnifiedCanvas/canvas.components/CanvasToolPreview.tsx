...
export const CanvasToolPreview: FC<GroupConfig> = props => {
  ...
  const shouldDrawBrushPreview = useRecoilValue(shouldDrawBrushPreviewSelector)
  ...
  const colorPickerColorString = useRecoilValue(colorPickerColorStringSelector)
  const colorPickerOuterRadius = useRecoilValue(colorPickerOuterRadiusSelector)
  const colorPickerInnerRadius = useRecoilValue(colorPickerInnerRadiusSelector)
