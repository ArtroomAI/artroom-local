...
} from './UnifiedCanvas/atoms/canvas.atoms'
...
} from './UnifiedCanvas/util'
import {
  CanvasImage,
  isCanvasMaskLine
} from './UnifiedCanvas/atoms/canvasTypes'
...
function Paint() {
  ...
  const [futureLayerStates, setFutureLayerStates] = useRecoilState(
    futureLayerStatesAtom
  )
    ...
    setLayerState({
      ...
      objects: [
        ...layerState.objects.filter(
          (object: CanvasImage) =>
            !(
              object.image?.url === imageData.path &&
      ...
      <VStack align="center" spacing={4}>
        ...
        {cloudMode ? (
          ...
          >
            ...
            <ChakraImage src={Shards} width="12px" />
