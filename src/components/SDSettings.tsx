        ...
        try {
          ...
          if (!isNaN(widthRatio) && !isNaN(heightRatio)) {
            newHeight = Math.min(
              1920,
              Math.floor(
                (imageSettings.width * heightRatio) / widthRatio / 64
              ) * 64
            )
          }
        } catch {}
      ...
      <Box m="-1" p={4} rounded="md">
        <VStack className="sd-settings" spacing={3}>
          ...
          <Box className="size-input" width="100%">
            <FormControl className=" aspect-ratio-input" marginBottom={2}>
              ...
              <HStack>
                  ...
                  onChange={event => {
                    ...
                    if (
                      ...
                      toast({
                        ...
                        description:
                          'Must upload Starting Image first to use its resolution',
                        status: 'error',
                        position: 'top',
                        duration: 3000,
                        isClosable: true,
                ...
                >
                  ...
                  {imageSettings.init_image.length && (
                    <option
          ...
          <FormControl className="samplers-input">
            ...
            <Select
              ...
              variant="outline"
            >
              <option style={{ backgroundColor: '#080B16' }} value="ddim">
                DDIM
              </option>

              <option style={{ backgroundColor: '#080B16' }} value="dpmpp_2m">
                DPM++ 2M Karras
              </option>
              ...
              <option style={{ backgroundColor: '#080B16' }} value="euler">
                Euler
              </option>

              <option style={{ backgroundColor: '#080B16' }} value="euler_a">
                Euler Ancestral
              </option>

              <option style={{ backgroundColor: '#080B16' }} value="dpm_2">
                DPM 2
              </option>

              <option style={{ backgroundColor: '#080B16' }} value="dpm_a">
                DPM 2 Ancestral
              </option>

              <option style={{ backgroundColor: '#080B16' }} value="lms">
                LMS
              </option>

              <option style={{ backgroundColor: '#080B16' }} value="heun">
                Heun
              </option>

              <option style={{ backgroundColor: '#080B16' }} value="plms">
                PLMS
              </option>
            </Select>
          </FormControl>
          ...
          <FormControl className="model-ckpt-input">
            ...
            <Select
              ...
              name="ckpt"
              onChange={event =>
                setImageSettings({ ...imageSettings, ckpt: event.target.value })
              }
            ...
            >
              {ckpts.length > 0 ? (
                <option style={{ backgroundColor: '#080B16' }} value="">
          ...
          <FormControl className="vae-ckpt-input">
            ...
            <Select
              ...
              name="vae"
              onChange={event =>
                setImageSettings({ ...imageSettings, vae: event.target.value })
              }
              onMouseEnter={getCkpts}
            ...
            <VStack align="center" justify="center">
              ...
              <Checkbox
                ...
                onChange={() => {
                  setImageSettings({
                    ...imageSettings,
                    use_random_seed: !imageSettings.use_random_seed
                  })
                }}
                pb="12px"
              />
